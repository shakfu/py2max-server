...
class TestReplClientImport:
    ...
    def test_import_repl_client(self):
        ...
        from py2max_server.client import ReplClient, start_repl_client
    ...
    def test_import_all_exports(self):
        ...
        from py2max_server import client
...
class TestReplClient:
    ...
    def test_init_defaults(self):
        ...
        from py2max_server.client import ReplClient
    ...
    async def test_connect_authenticates_first(self):
        ...
        with patch("py2max_server.client.connect", AsyncMock(return_value=mock_ws)):
    ...
    async def test_connect_success(self, capsys):
        ...
        with patch("py2max_server.client.connect", side_effect=mock_connect):
            await client.connect()
    ...
    async def test_connect_failure(self, capsys):
        ...
        with patch(
            "py2max_server.client.connect", side_effect=Exception("Connection refused")
        ):
...
class TestStartReplClient:
    ...
    async def test_start_repl_client_success(self):
        ...
        with patch("py2max_server.client.connect", side_effect=mock_connect):
            with patch(
                "py2max_server.client.ReplClient.run_repl", new_callable=AsyncMock
            ):
