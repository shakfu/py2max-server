"""Tests for nested patcher (subpatcher) handling in the interactive editor.

Core nested-patcher behavior (parent references, save round-trip) is tested in
the py2max package; these tests cover the server's state serialization and the
WebSocket handler's subpatcher navigation.
"""

import pytest
from py2max import Patcher
from py2max_server import InteractiveWebSocketHandler, get_patcher_state_json
