...
from py2max_server.repl import ReplCommands
...
class TestReplIntegration:
    ...
    async def test_start_repl_basic(self, patcher, mock_server):
        ...
        with patch("py2max_server.repl.embed") as mock_embed:
            mock_embed.side_effect = EOFError()

            from py2max_server.repl import start_repl
...
class TestAutoSyncWrapper:
    ...
    def test_autosync_wrapper_exists(self):
        ...
        from py2max_server.repl import AutoSyncWrapper
