...
class TestReplInlineImport:
    ...
    def test_import_repl_inline(self):
        ...
        from py2max_server.inline import (
    ...
    def test_import_all_exports(self):
        ...
        from py2max_server import inline
...
class TestSetupFileLogging:
    ...
    def test_setup_file_logging_creates_file(self, tmp_path):
        ...
        from py2max_server.inline import restore_console_logging, setup_file_logging
...
class TestBackgroundServerREPL:
    ...
    def test_init_defaults(self, patcher):
        ...
        from py2max_server.inline import BackgroundServerREPL
...
class TestStartInlineRepl:
    ...
    async def test_start_inline_repl_creates_log_dir(
        ...
        from py2max_server.inline import start_inline_repl

        log_file = tmp_path / "logs" / "server.log"

        # Mock start_repl (imported inside the function from py2max_server.repl)
        with patch("py2max_server.repl.start_repl", new_callable=AsyncMock):
...
class TestStartBackgroundServerRepl:
    ...
    async def test_start_background_server_repl_creates_repl(self, patcher, tmp_path):
        ...
        from py2max_server.inline import start_background_server_repl

        log_file = tmp_path / "server.log"

        # Mock BackgroundServerREPL.start
        with patch(
            "py2max_server.inline.BackgroundServerREPL.start", new_callable=AsyncMock
        ):
            # Should not raise
